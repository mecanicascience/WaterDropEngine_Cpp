...
namespace wde::renderEngine {
	...
	class RenderSubpassType {
		public:
			 ...
			 * @param inputAttachmentBindingIndices The IDs of the attachments in the render pass that the sub-pass shaders can read from
			 ...
			 */
			RenderSubpassType(uint32_t bindingIndex, std::vector<uint32_t> attachmentBindingIndices, std::vector<uint32_t> inputAttachmentBindingIndices = {},
			    ...
			    _bindingIndex(bindingIndex), _attachmentBindingIndices(attachmentBindingIndices), _inputAttachmentBindingIndices(inputAttachmentBindingIndices),
			...
			const std::vector<uint32_t> getInputAttachmentBindingIndices() const { return _inputAttachmentBindingIndices; }
		...
		private:
			...
			std::vector<uint32_t> _inputAttachmentBindingIndices {};
